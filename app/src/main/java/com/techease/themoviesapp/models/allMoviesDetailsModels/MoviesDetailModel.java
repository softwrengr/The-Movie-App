package com.techease.themoviesapp.models.allMoviesDetailsModels;
...
public class MoviesDetailModel {
    ...
    @Expose
    private List<GenresDataModel> genres = null;
    ...
    public void setGenres(List<GenresDataModel> genres) {
        this.genres = genres;
    }
